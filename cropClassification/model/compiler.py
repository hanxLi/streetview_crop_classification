...
class ModelCompiler:
    ...
    def save_checkpoint(self, epoch, final=False):
        ...
        if final:
            ...
            save_path = self.checkpoint_dir / f"{epoch}_model_weights.pth"
    ...
    # Uncertainty WIP......
    # def predict_uncertainty(self, image_path, csv_path, step=16, window_size=(224, 224), 
    ...
    #         if save_path:
    #             save_prediction_results(image_path, 
    #                                     pred_mask, 
